...
describe('MenuService', () => {
  ...
  it('should create menu - (isAllowed === true)', inject(
    [MenuService],
    (service: MenuService) => {
  ...
  it('should create menu - isActive, isLink, isNode, isFullspan', inject(
    [MenuService],
    (service: MenuService) => {
      service.setPermissionVerificationFunction(hasPermission);
      const menuTree = service.buildMenuTree(DefaultMenuTree);
      ...
      expect(
        subscriptions[0].isActive('/admin/accounts/Subscriptions')
      ).toEqual(true);
  ...
  it('should create menu - (isAllowed === false)', inject(
    [MenuService],
    (service: MenuService) => {
      service.setPermissionVerificationFunction(hasPermission);
      const menuTree = service.buildMenuTree(DefaultMenuTree);
  ...
  it('should create menu - target & external, icon', inject(
    [MenuService],
    (service: MenuService) => {
      service.setPermissionVerificationFunction(hasPermission);
      const menuTree = service.buildMenuTree(DefaultMenuTree);
  ...
  it('should create menu - children, allowed, no icons', inject(
    [MenuService],
    (service: MenuService) => {
      service.setPermissionVerificationFunction(hasPermission);
      const menuTree = service.buildMenuTree(DefaultMenuTree);
  ...
  it('should create menu - offset, node, link, internal, external ...', inject(
    [MenuService],
    (service: MenuService) => {
      service.setPermissionVerificationFunction(hasPermission);
      const menuTree = service.buildMenuTree(DefaultMenuTree);
  ...
  it('should create menu - empty name ...', inject(
    [MenuService],
    (service: MenuService) => {
      expect(() => {
